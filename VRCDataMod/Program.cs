...
public class DataPack
{
    ...
    public DataPackage GetDataPackage()
    {
        ...
        if (packageEntry != null)
        {
            ...
            return JsonSerializer.Deserialize<DataPackage>(packageJson, DataPackageOptions);
        }
        else
            throw new Exception("package.json entry not found in the ZIP archive.");
    }
    static readonly JsonSerializerOptions DataPackageOptions = new()
    {
        TypeInfoResolver = DataPackageJsonContext.Default
    };
}

[JsonSerializable(typeof(DataPackage))]
public partial class DataPackageJsonContext : JsonSerializerContext
{
}
